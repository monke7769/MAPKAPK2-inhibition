...
for mol in molecules:
    Chem.AddHs(mol)  # Add hydrogens to the molecule
    AllChem.EmbedMolecule(mol, AllChem.ETKDG())
    AllChem.UFFOptimizeMolecule(mol)  # Optimize the 3D structure using UFF force field
# sanitize and standardize your molecules if needed

transformer = MoleculeTransformer(featurizer=Pharmacophore3D(factory='gobbi'), dtype=float)
